...
| 项目 | 内容 |
|------|------|
| **标题** | 纵横视角下人工智能素养的理论研究与行动启示 |
| **期刊** | 现代教育技术 |
| **评价** | 🟡 间接相关：提供素养演进框架 |

### 核心框架
**技术相关素养的四阶段演进**：
1. 信息素养/数字素养阶段（计算机与网络）
2. 类AI素养阶段（数据素养、机器学习素养）
3. AI素养阶段（当前）
4. 新一轮数字素养阶段（数字化转型）
...
## 第十五篇：Gonzalez et al. (2022) - 🟡

### 基本信息
| 项目 | 内容 |
|------|------|
| **标题** | Allying with AI? Reactions toward human-based, AI/ML-based, and augmented hiring processes |
| **期刊** | Computers in Human Behavior |
| **方法** | 两项实验（n=183学生, n=163 Prolific成人） |
| **评价** | 🟡 间接相关：招聘情境AI反应 |

### 核心发现
**H1支持**: 人类主导和增强式(augmented)招聘 > 纯AI/ML招聘
- 程序公正、互动公正、自我效能感均更高
- 接受offer意愿：Human 68% vs AI 57%

**H3支持**: AI熟悉度调节效应
- 低AI熟悉度者：对纯AI/ML反应最负面
- 高AI熟悉度者：对三种方式反应差异不显著

### 对论文贡献
| 方面 | 贡献 |
|------|------|
| **P4类比** | 员工对AI决策的接受度取决于"人类参与程度"→ 类比上级开放性 |
| **调节逻辑** | AI熟悉度类似于AI素养作为边界条件 |

---

## 第十六篇：Bosse, Thompson & Ekman (2022) - 🟡

### 基本信息
| 项目 | 内容 |
|------|------|
| **标题** | In consilium apparatus: Artificial intelligence, stakeholder reciprocity, and firm performance |
| **期刊** | Journal of Business Research |
| **评价** | 🟡 间接相关：理论框架文献 |

### 核心框架
**利益相关者理论 + AI**：
- 分配公正(Distributional justice)
- 程序公正(Procedural justice)
- 互动公正(Interactional justice)

**三个命题**：
1. AI需估计利益相关者对三维公正的期望 → 正向互惠
2. AI需感知正向/负向互惠行为 → 正向互惠
3. 多系统集成 → 正向互惠
...
| 项目 | 内容 |
|------|------|
| **标题** | 人工智能赋能企业工商管理的决策优化策略探讨 |
| **期刊** | 普通期刊 |
| **评价** | ⚪ **低相关**：实践应用类文章，无理论贡献 |
...
**评估**：该文献为一般性实践描述，缺乏理论支撑和实证数据，对本研究无直接贡献。
...
### AI素养定义
- **采纳**：钟柏昌(2024)三维框架（知识+情感+思维）
- **补充**：尹开国(2024)五维、赵益民(2025)四维

### 核心机制发现
1. **AI素养双刃剑效应**（叶慧莉2025）：创造力自效能 vs 技术焦虑
2. **代际AI差距量化**（Nebgen & Kurz）：Gen Z 41% vs Gen X 13%
3. **组织公正视角**（Bennett & Martin）：上级开放性 ≈ 程序公正
4. **AI-HRM阴影体验**（Zheng 2024）：提供对比视角
