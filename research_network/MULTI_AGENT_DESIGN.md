...
```bash
# 安装依赖
pip install -r research_network/requirements.txt
...
| 文件 | 用途 |
|------|------|
| `research_network/network.yaml` | 网络配置 |
| `research_network/agents/academic_partner.yaml` | 协调者 Agent |
| `research_network/agents/literature_agent.yaml` | 文献专家 Agent |
| `research_network/agents/pr_manager.yaml` | PR 管理 Agent |
| `research_network/agents/archivist.yaml` | 档案管理 Agent |
| `research_network/mods/memory_system.py` | 记忆系统核心 |
| `research_network/tools/document_tools.py` | 文档工具 |
| `research_network/tools/memory_tools.py` | 记忆工具 |
| `MEMORY.md` | 记忆备份文件 |
