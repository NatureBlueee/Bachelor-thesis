...
AI素养正是这样一种资源。本研究采用钟柏昌、刘晓凡和杨明欢（2024）提出的三维框架：*AI知识*（对AI概念与技术的理解）、*AI情感*（对AI的情感态度与使用动机）、*AI思维*（将AI融入问题解决的高阶认知能力）。当Z世代员工在这些维度上超越其上级，他们便获得了一种非正式的资源优势——原则上，这应当使向上影响成为可能。
