...
1. **thesis_project.md**: "禁止忽略用户纠正" → 加入"经过思考和评估后"
2. **thesis_project.md**: "遇到分歧时" → "深入的思考，不要讨好也不要卑微"
3. **writing.md**: 允许使用假设数据，但必须验证调查计划涵盖且明确标注
4. **writing.md**: 删除"禁止改变已有论述逻辑"
5. **context_update.md**: 触发时机加入"与我或导师讨论后"
